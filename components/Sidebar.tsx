...
import { Sparkles, FolderOpen, Plus, LogOut, Lock } from 'lucide-react';
...
interface SidebarProps {
  ...
  userEmail: string;
  handleSignOut: () => void;
  // On garde cette prop même si on ne l'utilise plus pour l'instant (pour éviter les erreurs dans page.tsx)
...
export default function Sidebar({
  ...
  return (
    <div className="w-full h-full bg-white border-r border-slate-200 p-6 flex flex-col overflow-y-auto gap-8">
      ...
      {/* 3. IA GENERATOR (DÉSACTIVÉ / COMING SOON) */}
      ...
      <div className="grow flex flex-col min-h-0">
        ...
        <textarea
          className="grow w-full p-3 text-sm border border-slate-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:outline-none font-mono text-xs leading-relaxed resize-none"
          value={inputText}
